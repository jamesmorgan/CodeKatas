...
public class AcceptanceTests {
	...
	@Test
	public void romanNumeralForSevenIsVII() throws Exception {
		assertEquals("VII", convert(7));
	}

	@Test
	public void romanNumeralForEightIsVIII() throws Exception {
	...
	@Test
	public void romanNumeralForTwelveIsXII() throws Exception {
		assertEquals("XII", convert(12));
	}

	@Test
	public void romanNumeralForThirteenIsXIII() throws Exception {
	...
	@Test
	public void romanNumeralForSixteenIsXVI() throws Exception {
		assertEquals("XVI", convert(16));
	}

	@Test
	public void romanNumeralForSeventeenIsXVII() throws Exception {
		assertEquals("XVII", convert(17));
	}

	@Test
	public void romanNumeralForEightteenIsXVIII() throws Exception {
		assertEquals("XVIII", convert(18));
	}
	...
	@Test
	public void romanNumeralForTwentyOneIsXXI() throws Exception {
		assertEquals("XXI", convert(21));
	}

	@Test
	public void romanNumeralForTwentyTwoIsXXII() throws Exception {
		assertEquals("XXII", convert(22));
	}

	@Test
	public void romanNumeralForTwentyThreeIsXXIII() throws Exception {
		assertEquals("XXIII", convert(23));
	}

	@Test
	public void romanNumeralForTwentyFourIsXXIIII() throws Exception {
		assertEquals("XXIV", convert(24));
	}

	@Test
	public void romanNumeralForTwentyFiveIsXXV() throws Exception {
		assertEquals("XXV", convert(25));
	}
